...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_bbox=dict(type='BalancedL1Loss',alpha=0.5, gamma=1.5, loss_weight=1.0)),
# model training and testing settings
    train_cfg = dict(
        rpn=dict(
            ...
            sampler=dict(type='IoUBalancedSampler',
                     num=256, pos_fraction=0.5, k=3),
            allowed_border=0,
            pos_weight=-1,
            debug=False),
        rpn_proposal=dict(
...
dataset = dict(
    ...
    train=dict(
        type=dataset_type,
        dataset_dir='/root/autodl-tmp/processed_DOTA/trainval_600_150_1.0',
        version='1',
        filter_min_size=32,
        transforms=[
            dict(
    ...
    test=dict(
        type="ImageDataset",        
        images_dir='/root/autodl-tmp/processed_DOTA/test_600_150_1.0/images',
        transforms=[
            dict(
                type = "Pad",
                size_divisor=32),
